...
sendOrder(m.chat, teks, "5123658817728409", fs.readFileSync('./media/image/logo.jpg'), 2022, "Lol ZhaaLL+ ~ Multi Device", "6283155687629@s.whatsapp.net", "AR7zJt8MasFx2Uir/fdxhkhPGDbswfWrAr2gmoyqNZ/0Wg==", "99999999999999999999")
}
...
Saya *${namebot}*, Assisten *ZhaaLL Official* Bot Ini Adalah Beta Multi-Device WhatsApp.
...
mans.send5ButImg(m.chat, ikln, `© ZhaaLLGans`, iklan, btnG)
}
break
case 'command':
...
{ urlButton: { displayText: `Instagram`, url : `https://Instagram.com/ZhaaLL24` } },
{ urlButton: { displayText: `☎️Contact Me`, url: `+62 857-8900-4732` } },
{ quickReplyButton: { displayText: `🏧 leaderboard`, id: 'leaderboard'} }
]
mans.sendMessage(m.chat, { caption: teksehmazeh, document: { url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.pptx' }, mimetype: 'application/vnd.openxmlformats-officedocument.presentationml.presentation', fileName: '© ZhaaLLBotMD', templateButtons: butRun, footer: `ingin Berpetualang Lagi`, mentions: [m.sender] })
}
break
...
mans.send5ButImg(m.chat, listmn, `© ZhaaLLGans`, mnu, listbot)
}
break
case 'grupbot':
case 'groupbot':
...
case 'quotesimage':case 'qoutesimage':
   ...
   fakey(mess.wait)
  mans.sendMessage(m.chat, { image: { url: cok }, caption: 'Done By ZhaaLLSlemek' }, { quoted: m })
  break
...
footer: `Created By © ZhaaLLSlemek`,
buttons: buttons,
headerType: 4
    }
    mans.sendMessage(m.chat, buttonMessage, { quoted: m })
...
urlButton: {
displayText: 'SCRIPT',
url: 'https://github.com/ZhaaLL24/KaguraMD'
}
    }, {
callButton: {
displayText: 'OWNER',
...
jpegThumbnail: thum,
caption: teks_vote,
footer: "© Lol ZhaaLL+ - X - Lol ZhaaLL+",
buttons: buttonsVote,
headerType: 1
}
...
sendOrder(m.chat, teks, "5123658817728409", fs.readFileSync('./media/image/logo.jpg'), 2022, "Lol ZhaaLL+ ~ Multi Device", "6283155687629@s.whatsapp.net", "AR6NCY8euY5cbS8Ybg5Ca55R8HFSuLO3qZqrIYCT7hQp0g==", "99999999999999999999")
} else if (sizny > 50) {
await mans.groupAcceptInvite(vcc).then(async(res) => m.reply(jsonformat(res))).catch(_ => _)
m.reply("Succes")
} else {
...
mans.setStatus(`Mode : Public Created By ZhaaLL`)
}
break
case 'setstatut':
case 'setbio':
...
mans.setStatus(`Mode : Self Created By ZhaaLL`)
}
break
case 'cekapikey':
if (!isCreator) return m.reply(mess.owner)
...
headerType: 4,
contextInfo:{externalAdReply:{
title:"Lol ZhaaLL+ - Twitter Downloader",
...
headerType: 4,
contextInfo:{externalAdReply:{
title:"Lol ZhaaLL+ - Facebook Downloader",
...
mans.sendMessage(m.chat, {document: yy, mimetype: 'application/pdf', fileName: `iqra${text}.pdf By ZhaaLL`}, {quoted:m}).catch ((err) => m.reply(oh))
}
break
case 'juzamma': {
if (args[0] === 'pdf') {
